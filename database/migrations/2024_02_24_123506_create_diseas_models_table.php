...
return new class extends Migration
{
    ...
    {
        Schema::create('diseas_models', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('diseas_id')->nullable()->references('id')->on('diseas')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('diseas_models');
    }
};
