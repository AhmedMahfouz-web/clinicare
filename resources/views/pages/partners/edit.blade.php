                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6 mb-3">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                        placeholder="الاسم"value="{{ $partner->name }}" aria-label="الاسم"
                                        aria-describedby="basic-addon1">
                                </div>
                                <div class="form-group col-6 mb-3">
                                    <label for="bio" class="mr-1 control-label">نبذة</label>
                                    <input type="text" id="bio" value="{{ $partner->bio }}" name="bio"
                                        class="form-control" placeholder="نبذة" aria-label="نبذة"
                                        aria-describedby="basic-addon1">
                                </div>
                                <div class="form-group col-6 mb-3">
